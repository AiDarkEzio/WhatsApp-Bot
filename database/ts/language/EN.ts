export default {
    ...
    "STRINGS": {
        "_whats": {
            ...
            "WARN": "Warn",
            "DESCC": "It's send All Comands without cateory"
        },
        "_plugin": {
            ...
            "WARN": "Get plugins only from t.me/neotroplug channel."
        },
        "admin": {
        ...
        "heroku": {
            "RESTART_DESC": "Restart Queen Alexa",
            "RESTART_MSG": "*Restarting Queen Alexa...*",
            "SHUTDOWN_DESC": "Shutdown Queen Alexa",
            "SHUTDOWN_MSG": "*Shutting down ⛔ Queen Alexa*",
        ...
        "info": {
            "INFO_DESC": "Show chat details",
            "GRP_NAME": "*ℹ️ Group name :*",
            "GRP_JID": "*💬 Group JID :*",
            "GRP_OWN": "*⚜️ Group owner :*",
            "GRP_COD": "*🆔 Group invite link :*",
            "GRP_DES": "*🗨️ Group description :*",
            "PRO_JID": "*💬 User JID :*",
            "PRO_DES": "*🗨️ Description :*"
        },
        "greetings": {
            ...
            "RULE_DESC": "Shows the Group rules",
			"SETRULE_DESC": "It sets the Rule message..\n*Example:* _.setrules No Links#No Spamming_",
            "NOT_SET_RULE": "🦹🏼‍♀️ *You don't set the Rule message yet.!*\n*Example:* _.setrules No Links#No Spamming_",
            "NEED_RULE_TEXT": "🦹🏼‍♀️ *You must write a message to set up the Rule message.*\n*Example* _.setrules No Links#No Spamming_",
            "RULE_DELETED": "*✅ Rule message has been deleted successfully!*",
            "RULE_SETTED": "*✅ Rule message has been set successfully!*",
        ...
        "profile": {
            "KICKME_DESC": "එය ඔබ භාවිතා කරන කණ්ඩායමෙන් ඔබව ඉවත් කරයි.",
            "KICKME": "```මම යනවා! ගිහින් එන්නම් 🤠```",
            "PP_DESC": "ඔබ පිළිතුරු දෙන ඡායාරූපය පැතිකඩ ඡායාරූපය කරයි.",
            "NEED_PHOTO": "*මට ඡායාරූපයක් දෙන්න!*",
            "PPING": "```Profile ඡායාරූපය සැකසීම...```",
            "BLOCK_DESC": "පරිශීලක අවහිර කිරීම.",
            "UNBLOCK_DESC": "පරිශීලක වාරණය ඉවත් කිරීම.",
            "BLOCKED": "අවහිර කර ඇත",
            "UNBLOCKED": "Unblock කර ඇත",
            "BLOCKED_UPPER": "අවහිර කර ඇත!",
            "UNBLOCKED_UPPER": "Unblock කර ඇත.",
            "NEED_USER": "මට user කෙනෙක් mention කරන්න.!",
            "JID_DESC": "User's JID දීම.",
            "JID": "```JID address of``` @{} ```: {}```",
        ...
        "scrapers": {
            ...
            "NEED_VIDEO": "*Please write a video link!*\n*Example:* ```.video https://www.youtube.com/watch?v=nAFlV5qeBc```",
        ...
        "sticker": {
            ...
            "DOWNLOADING": "```Queen alexa Creating Sticker```"
        },
        "system_stats": {
            "ALIVE_DESC": "Shows the system properties. && Does bot work?"
        },
        "tagall": {
            "TAGALL_DESC": "Tags everyone in the group.",
            "ADMIN": "*I am not admin in this group!*",
            ...
            "PLKADMIN": ".report you are not admin \n\n 🇩🇴🇳🇹 🇹🇷🇾 🇦🇬🇦🇮🇳, 🇮🇫 🇾🇴🇺 🇹🇷🇾 🇾🇴🇺 🇼🇮🇱🇱 🇧🇪 🇷🇪🇲🇴🇻🇪🇩 🇧🇾 🇦🇩🇲🇮🇳🇸",
            "TAGADMIN": "Tags group admins.",
            "REPORT": "Sends reports to group admins.",
            "USER": "=== ```Report``` ===\n\n*User:* ",
            "REASON": "\n*Reason:* ",
            "REPLY": "*Please Respond to User's Message to Report!*",
            "WREPORT": "Sends warning reports to group admins.",
            "WUSER": " ```⚠️ Warning ⚠️``` \n\n ```1 warnings remaining``` \n\n *User:* ",
            "WREASON": "\n*Reason of warn:* ",
            "WREPLY": "*Please Respond to User's Message to Warning!*"
        },
        "updater": {
            ...
            "UPDATED": "**◄━━━━━━━⦁⦁◯⦁⦁━━━━━━━━►*\n  *⦁◊═⦁QUEEN 👸 ALEXA⦁═◊⦁*\n*Updated!*",
            "UPDATED_LOCAL": "*👸 Queen alexa Updated!*",
            "AFTER_UPDATE": "*Queen alexa Restarting !*",
        ...
        "web": {
            ...
            "VALID": "*Please Use As Applicable!* \n*.calc 1 + 2*\n*.calc 3 x 5*\n*.calc 10 / 5*\n*.calc 5 - 2*",
            "PING_DESC": "Measures your ping.",
            "URL": "Shorten the long link."
        },
        "conventer": {
            "MP4TOAUDIO_DESC": "වීඩියෝව mp3 බවට පරිවර්තනය කරයි.",
            "MP4TOAUDIO_NEEDREPLY": "*ඔබ වීඩියෝවකට mention දිය යුතුය!*",
            "MP4TOAUDIO": "\n```🔄 වීඩියෝව mp3 බවට පරිවර්තනය කිරීම..```\n",
            "STICKER_DESC": "ස්ටිකරය ඡායාරූපයකට පරිවර්තනය කරයි.",
            "STICKER_NEEDREPLY": "*ඔබ ස්ටිකරයකට mention දිය යුතුය!*",
            "STICKER": "\n```🔄 ස්ටිකරය ඡායාරූපයකට පරිවර්තනය කිරීම..```\n",
            "XMEDIA_DESC": "එය මාධ්‍ය මෙවලම් 25 කට වඩා ඇති ප්ලගිනයකි.",
            ...
            "ADMIN_DES": "Bot Owner Command list" 
        },
        "mute": {
            "BIRMUTE": "*The group was silenced for 1 minute!*",
            "IKIMUTE": "*The group was silenced for 2 minute!*",
            ...
            "YEDIMUTE": "*The group was silenced for 7 minute!*",
            "SEKIZMUTE": "*The group was silenced for 8 minute!*",
            "DOKUZMUTE": "*The group was silenced for 9 minute!*",
            "ONMUTE": "*The group was silenced for 10 minute!*",
            "ONBIRMUTE": "*The group was silenced for 11 minute!*",
            "ONIKIMUTE": "*The group was silenced for 12 minute!*",
            ...
            "ONYEDIMUTE": "*The group was silenced for 17 minute!*",
            "ONSEKIZMUTE": "*The group was silenced for 18 minute!*",
            "ONDOKUZMUTE": "*The group was silenced for 19 minute!*",
            "YIRMIMUTE": "*The group was silenced for 20 minute!*",
            "YIRMIBIRMUTE": "*The group was silenced for 21 minute!*",
            "YIRMIIKIMUTE": "*The group was silenced for 22 minute!*",
            "YIRMIÜÇMUTE": "*The group was silenced for 23 minute!*",
            "YIRMIDÖRTMUTE": "*The group was silenced for 24 minute!*",
            "YIRMIBEŞMUTE": "*The group was silenced for 25 minute!*",
            "YIRMIALTIMUTE": "*The group was silenced for 26 minute!*",
            "YIRMIYEDIMUTE": "*The group was silenced for 27 minute!*",
            "YIRMISEKIZMUTE": "*The group was silenced for 28 minute!*",
            "YIRMIDOKUZMUTE": "*The group was silenced for 29 minute!*",
            "OTUZMUTE": "*The group was silenced for 30 minute!*",
            "OTUZBIRMUTE": "*The group was silenced for 31 minute!*",
            "OTUZIKIMUTE": "*The group was silenced for 32 minute!*",
            ...
            "OTUZYEDIMUTE": "*The group was silenced for 37 minute!*",
            "OTUZSEKIZMUTE": "*The group was silenced for 38 minute!*",
            "OTUZDOKUZMUTE": "*The group was silenced for 39 minute!*",
            "KIRKMUTE": "*The group was silenced for 40 minute!*",
            "KIRKBIRMUTE": "*The group was silenced for 41 minute!*",
            "KIRKIKIMUTE": "*The group was silenced for 42 minute!*",
            ...
            "KIRKYEDIMUTE": "*The group was silenced for 47 minute!*",
            "KIRKSEKIZMUTE": "*The group was silenced for 48 minute!*",
            "KIRKDOKUZMUTE": "*The group was silenced for 49 minute!*",
            "ELLIMUTE": "*The group was silenced for 50 minute!*",
            "ELLIBIRMUTE": "*The group was silenced for 51 minute!*",
            "ELLIIKIMUTE": "*The group was silenced for 52 minute!*",
            "ELLIÜÇMUTE": "*The group was silenced for 53 minute!*",
            "ELLIDÖRTMUTE": "*The group was silenced for 54 minute!*",
            "ELLIBEŞMUTE": "*The group was silenced for 55 minute!*",
            "ELLIALTIMUTE": "*The group was silenced for 56 minute!*",
            "ELLIYEDIMUTE": "*The group was silenced for 57 minute!*",
            "ELLISEKIZMUTE": "*The group was silenced for 58 minute!*",
            "ELLIDOKUZMUTE": "*The group was silenced for 59 minute!*",
            "SAATBIRMUTE": "*The group was silenced for 1 hour!*",
            "SAATIKIMUTE": "*The group was silenced for 2 hour!*",
            ...
            "SAATYEDIMUTE": "*The group was silenced for 7 hour!*",
            "SAATSEKIZMUTE": "*The group was silenced for 8 hour!*",
            "SAATDOKUZMUTE": "*The group was silenced for 9 hour!*",
            "SAATONMUTE": "*The group was silenced for 10 hour!*",
            "SAATONBIRMUTE": "*The group was silenced for 11 hour!*",
            "SAATONIKIMUTE": "*The group was silenced for 12 hour!*",
            "GÜNBIRMUTE": "*The group was silenced for 1 day!*",
            "GÜNIKIMUTE": "*The group was silenced for 2 day!*",
        ...
        "unvoice": {
            ...
            "SPDF_DESC": "Converts a Site into PDF",
            "SPDF_LINK": "*You Must Enter a URL*",
            "SPDF_PROC": "```Converting Site into PDF```"
        ...
        "spammer": {
            ...
            "VID_DESC": "Sends the replied video as spam.",
            "VID_NEED": "```Please Reply to Any Video!```"
        },
        "carbon": {
        ...
        "instagram": {
            ...
            "NAME": "Name",
            "BIO": "Biography",
            "FIX": "*Carrying out maintenance work!*",
            "FOLLOWERS": "Followers",
            "FOLLOWS": "Follows",
        ...
        "github": {
            "GITHUB_DESC": "Collects github information from the given username.\n⌨️ Example: .github zeqanpx",
            ...
            "GIST": "Public Gists:",
            "JOIN": "Joining Date:",
            "HIRE_FALSE": "Cannot Hirable 🚫",
            "HIRE_TRUE": "Hirable ☑️",
            "HIRE": "Can s/he Hirable?:",
            "URL": "Profile URL:",
            "UPDATE": "Last Update:",
            "BOT_DESC": "Chat with.\n Use .molu <message>",
            "BOT": ":",
            "JOKE_DESC": "Get a random joke.",
            "DEVICE": "get the details of given mobile phone",     
            "JOKE": "Joke:",
            "PUNCHLINE": "Punchline:",
            "EVINS_DESC": "Get an evil insult.",
            "EVINS": "...",
            "NEWEP": "confused about updates..? use to know about updates "
        ...
        "whats_bot": {
            "ERR": "ERROR: ",
            "APK": "GET mod app link.",
            "ANIM_DESC": "```Send Random Anime Wallpapers!```",
            "BR_DESC": "Ask a quation",
            "ANTI": "Turn On AntiLink",
            "DEVICE": "get phone details",
            "SPDF": "Converts website link to pdf",
            "CARBON": "converts Text to java-Carbon logo",
            "CURRENCY": "get money units information",
            "CLEAR": "clear Chats",
            "BUGHOLE": "GROUP crash ◁Bug Hole▷",
            "MP4": "Direct Video Downloader",
            "WORK": "change bot work type.\n📑.work public/private",
            "FRANCY": "Text Styles",
            "MOVIE": "Show movie details",
            "BOT_DESC": "Chat with AI sim bot .bot < your msg >",
            "PINSTA": "Download Instergram post",
            "VINSTA": "Download instergram video",
            "PKG": "install official Amazone plugins",
            "REMOVE": "Remove Official plugins",
            "PLUG": "Show official plugins list",
            "MMPACK": "Show  meme maker list",
            "ANIMELIST": "More Anime photos",
            "SHOW": "show tv series details",
            "TWT": "Download video from twitter",
            "TTP": "get ttp list",
            "WALL": "Random Esthetic wallpaper",
            "AI": "AI chat bot.",
            "MENU": "show Button message menu",
            "NOT_FOUNDAC": "*⛔Invaild Request*",
            "NEED_LOCATIONA": "*⛔Invaild Request*",
            "ADON_DESC": "AI  Chat bot on / off.\n⌨️example: AI chat bot on, .adon AI_BOT:true use command.\nAI chat bot off, .adon AI_BOT:false use command.",
            "ADON_MISSING": "```Command disabled.```",
            "ADON_SUCCESS": "```✅Success```",
            "ADON_INVALID": "```විධානය අවලංගුය.```",
            "BOT": ":",
            "SONG": "Download song as document",
            "TIKTOK": "Download tik tok video",
            "C": "👩‍🦰",
            "D": "📑",
            "E": "👩‍🦰",
            "NOT_AVAILABLE": "👩‍🦰Amazone chat bot Disabled."
        },
        "covid": {
